<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <tbody>
            @foreach ($kinerjaData as $kinerja)
                <tr
                    ...
                    <td class="px-6 py-4">
                        <a href="#" type="button" data-modal-target="addKinerjaModal"
                            data-modal-show="addKinerjaModal" type="button"
                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                        <form action="/target_kinreja/kinerjas/{{ $kinerja->id }}" method="POST"
                            class="inline-block">
                            @method('delete')
                            @csrf
    ...
    {{-- @include('modals.EditKinerjaModals') --}}
