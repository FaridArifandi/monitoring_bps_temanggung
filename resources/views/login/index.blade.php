...
<body>
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            {{-- allert succes registration --}}
            @if (session()->has('succes'))
                <div id="alertSuccesRegritration"
                    ...
                    <button type="button"
                        ...
                        data-dismiss-target="#alertSuccesRegritration" aria-label="Close">
            ...
            @if (session()->has('loginError'))
                <div id="alertLoginError"
                    ...
                    <button type="button"
                        ...
                        data-dismiss-target="#alertLoginError" aria-label="Close">
                    ...
                    <form class="space-y-4 md:space-y-6" action="/login" method="POST">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email"
                                ...
                                placeholder="email@gmail.com" required="" autofocus value="{{ old('email') }}">
                            @error('email')
