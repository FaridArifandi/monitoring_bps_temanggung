<div id="addKinerjaModal" tabindex="-1" aria-hidden="true"
    class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-2xl max-h-full">
        <!-- Modal content -->
        <form id="addKinerjaForm" action="/target_kinerja/kinerjas" method="POST"
            ...
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="addKinerjaModal">
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="number" name="target" id="target" value=""
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            required>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        startDateInput.addEventListener('change', function() {
            ...
            // If the current end date is before the start date, clear the end date
